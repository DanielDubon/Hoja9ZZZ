...
abstract public class GraphList<V,E> extends AbstractStructure<V> implements Graph<V,E>
{
    ...
    {
        structure5.Assert.condition(dict.containsKey(label), "Vertex exists");
    ...
    {
        structure5.Assert.condition(dict.containsKey(label1), "Vertex exists");
    ...
    {
        structure5.Assert.condition(dict.containsKey(vLabel1), "Vertex exists");
