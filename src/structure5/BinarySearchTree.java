    ...
    extends AbstractStructure<E> implements OrderedStructure<E>
{
    ...
    {
        structure5.Assert.pre(!root.isEmpty(), "No predecessor to middle value.");
        structure5.Assert.pre(!root.left().isEmpty(), "Root has left child.");
    ...
    {
        structure5.Assert.pre(!root.isEmpty(), "Tree is non-null.");
