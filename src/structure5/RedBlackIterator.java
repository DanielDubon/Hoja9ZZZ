...
class RedBlackIterator<E extends Comparable<E>> extends AbstractIterator<E>
{
     ...
     */
    protected structure5.RedBlackTree<E> root; // root of subtree to be traversed

    /** 
     * Stack of nodes that maintain the state of the iterator.
     */
    protected Stack<structure5.RedBlackTree<E>> todo; // stack of unvisited ancestors of current
     ...
     */
    public RedBlackIterator(structure5.RedBlackTree<E> root){
        todo = new StackList<structure5.RedBlackTree<E>>();
        this.root = root;
        reset();
    }   
    ...
    public void reset(){
        ...
        // leftmost descendant
        structure5.RedBlackTree<E> current = root;
        while (current != structure5.RedBlackTree.EMPTY) {
            todo.push(current);
     ...
     */
    public E next(){
        structure5.RedBlackTree<E> old = todo.pop();
        E result = old.value();
