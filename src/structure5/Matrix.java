...
public class Matrix<E>
{
    ...
    {
        structure5.Assert.pre(0 <= row && row < height, "Row in bounds.");
        structure5.Assert.pre(0 <= col && col < width, "Col in bounds.");
    ...
    {
        structure5.Assert.pre(0 <= r && r < width, "Row in bounds.");
        height++;
        Vector<E> theRow = new Vector<E>(width);
        for (int c = 0; c < width; c++)
        {
    ...
    {
        structure5.Assert.pre(0 <= c && c < width, "Col in bounds.");
        width++;
        for (int r = 0; r < height; r++)
        {
    ...
    {
        structure5.Assert.pre(0 <= r && r < height,"There is a row to be removed.");
