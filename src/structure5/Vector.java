...
public class Vector<E> extends AbstractList<E> implements Cloneable
{
    ...
    {
        structure5.Assert.pre(initialCapacity >= 0,"Capacity must not be negative");
    ...
    {
        structure5.Assert.pre(initialCapacity >= 0, "Capacity must not be negative.");
        structure5.Assert.pre(capacityIncr >= 0, "The capacity increment must be 0,"+
    ...
    {
        structure5.Assert.pre(initialCapacity >= 0, "Nonnegative capacity.");
        capacityIncrement = capacityIncr;
        elementData = new Object[initialCapacity];
        elementCount = 0;
...
@SuppressWarnings("unchecked")
    public Object clone()
    {
        ...
        } catch (CloneNotSupportedException e) { structure5.Assert.fail("Vector cannot be cloned."); }
        return copy;
    }
    ...
    {
        structure5.Assert.pre(0 <= index && index < size(),"index is within bounds");
        return get(index);
    }
