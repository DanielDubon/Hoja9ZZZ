 ...
 *      thesisSet.{@link #retainAll(structure5.Structure) retainAll(gradSet)};
...
public abstract class AbstractSet<E> extends AbstractStructure<E> implements Set<E>
{
     ...
     */
    public void addAll(structure5.Structure<E> other)
    {
     ...
     *       other
     */
    public boolean containsAll(structure5.Structure<E> other)
    {
        Iterator<E> i = other.iterator();
        while (i.hasNext())
        {
     ...
     */
    public void removeAll(structure5.Structure<E> other)
    {
        Iterator<E> i = other.iterator();
        while (i.hasNext())
        {
