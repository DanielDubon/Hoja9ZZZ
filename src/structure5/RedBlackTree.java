...
public class RedBlackTree<E extends Comparable<E>>
{
    ...
    {
        structure5.Assert.pre(v != null, "Red-black tree values must be non-null.");
        value = v;
        parent = null;
    ...
    */
    ...
    protected void rotateRight()
    {
        ...
        } else structure5.Assert.post(newRoot.isRoot(),"Rotate at root preserves root.");
    }
    ...
    protected void rotateLeft()
    {
        ...
        } else structure5.Assert.post(newRoot.isRoot(),"Left rotate at root preserves root.");
    }
    ...
    */
    ...
    protected boolean blackConsistency()
    {
        ...
        {
            structure5.Assert.debug("Tree consistency not tested at root.");
            return false;
        }
        if (!isBlack()) // root must be black
        {
            structure5.Assert.debug("Root is not black.");
            return false;
        }
